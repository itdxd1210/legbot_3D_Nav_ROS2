...
namespace ego_planner
{
  ...
  private:
    ...
    double odom_velocity_alpha_, max_odom_speed_, odom_height_offset_;

    /* planning data */
    bool trigger_, have_target_, have_odom_, have_new_target_;
    bool have_filtered_odom_vel_;
    double reference_progress_time_;
    legbot::Time last_odom_stamp_, emergency_start_time_;
    std::string odom_topic;

    std_msgs::msg::Int16 goFlag_;
    legbot::Publisher goFlagPub_;
    ...
    legbot::Timer exec_timer_, safety_timer_,go_timer_;
    legbot::Subscriber waypoint_sub_, odom_sub_, path_sub_;
    legbot::Publisher replan_pub_, new_pub_, bspline_pub_, data_disp_pub_;
